...
from .lightning_module import SIEPSLightningModule
...
class SIEPSEstimator(PyTorchLightningEstimator):
    """
    ...
    def _create_instance_splitter(self, module: SIEPSLightningModule, mode: str):
    ...
    def create_lightning_module(self) -> SIEPSLightningModule:
        return SIEPSLightningModule(
            lr=self.lr,
