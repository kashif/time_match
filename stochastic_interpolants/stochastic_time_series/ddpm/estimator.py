...
class DDPMEstimator(PyTorchLightningEstimator):
    """
    ...
    def _create_instance_splitter(self, module: DDPMLightningModule, mode: str):
    ...
    def create_lightning_module(self) -> DDPMLightningModule:
        return DDPMLightningModule(
            lr=self.lr,
