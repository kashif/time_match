...
from .lightning_module import FMLightningModule
...
class FMEstimator(PyTorchLightningEstimator):
    """
    ...
    def _create_instance_splitter(self, module: FMLightningModule, mode: str):
    ...
    def create_lightning_module(self) -> FMLightningModule:
