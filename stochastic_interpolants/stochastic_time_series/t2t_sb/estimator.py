...
from .lightning_module import T2TSBLightningModule
...
class T2TSBEstimator(PyTorchLightningEstimator):
    """
    ...
    def _create_instance_splitter(self, module: T2TSBLightningModule, mode: str):
