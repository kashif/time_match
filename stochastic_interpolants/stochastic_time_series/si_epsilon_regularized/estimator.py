...
from .lightning_module import SIEPSREGLightningModule
...
class SIEPSREGEstimator(PyTorchLightningEstimator):
    """
    ...
    def _create_instance_splitter(self, module: SIEPSREGLightningModule, mode: str):
    ...
    def create_training_data_loader(
        self,
        data: Dataset,
        module: SIEPSREGLightningModule,
    ...
    def create_lightning_module(self) -> SIEPSREGLightningModule:
        return SIEPSREGLightningModule(
            lr=self.lr,
