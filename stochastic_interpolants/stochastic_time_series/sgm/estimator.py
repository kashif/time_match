...
from .lightning_module import SGMLightningModule
...
class SGMEstimator(PyTorchLightningEstimator):
    """
    ...
    def _create_instance_splitter(self, module: SGMLightningModule, mode: str):
    ...
    def create_lightning_module(self) -> SGMLightningModule:
        return SGMLightningModule(
            lr=self.lr,
