...
from .lightning_module import SILightningModule
...
class SIEstimator(PyTorchLightningEstimator):
    """
    ...
    def _create_instance_splitter(self, module: SILightningModule, mode: str):
    ...
    def create_lightning_module(self) -> SILightningModule:
        return SILightningModule(
            lr=self.lr,
