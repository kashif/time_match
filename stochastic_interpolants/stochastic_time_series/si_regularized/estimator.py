...
from .lightning_module import SIREGLightningModule
...
class SIREGEstimator(PyTorchLightningEstimator):
    """
    ...
    def _create_instance_splitter(self, module: SIREGLightningModule, mode: str):
    ...
    def create_lightning_module(self) -> SIREGLightningModule:
        return SIREGLightningModule(
            lr=self.lr,
