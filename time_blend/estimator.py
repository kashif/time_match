...
from .lightning_module import TimeBlendLightningModule
...
class TimeBlendEstimator(PyTorchLightningEstimator):
    """
    Estimator class to train a TimeBlend model.

    This class is uses the model defined in ``TimeBlendModel``, and wraps it
    into a ``TimeBlendLightningModule`` for training purposes: training is
    ...
    def _create_instance_splitter(self, module: TimeBlendLightningModule, mode: str):
    ...
    def create_training_data_loader(
        self,
        data: Dataset,
        module: TimeBlendLightningModule,
    ...
    def create_lightning_module(self) -> TimeBlendLightningModule:
        return TimeBlendLightningModule(
            # loss=self.loss,
            lr=self.lr,
