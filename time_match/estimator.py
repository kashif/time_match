...
from .lightning_module import TimeMatchLightningModule
...
class TimeMatchEstimator(PyTorchLightningEstimator):
    """
    ...
    def _create_instance_splitter(self, module: TimeMatchLightningModule, mode: str):
    ...
    def create_training_data_loader(
        self,
        data: Dataset,
        module: TimeMatchLightningModule,
    ...
    def create_lightning_module(self) -> TimeMatchLightningModule:
        return TimeMatchLightningModule(
            # loss=self.loss,
            lr=self.lr,
